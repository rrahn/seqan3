...
{
    using materialised_column_t = std::vector<coordinate_t>;

    using iterator_tag = std::forward_iterator_tag;
    static constexpr bool const_iterable = true;

    // Single column with 5 entries as the seq2 has size 4 (need one more for the initialisation row).
    materialised_column_t column1 = materialised_column_t{{seqan3::detail::row_index_type{0u}, seqan3::detail::column_index_type{0u}},
                                                          {seqan3::detail::row_index_type{1u}, seqan3::detail::column_index_type{0u}},
                                                          {seqan3::detail::row_index_type{2u}, seqan3::detail::column_index_type{0u}}};
    materialised_column_t column2 = materialised_column_t{{seqan3::detail::row_index_type{0u}, seqan3::detail::column_index_type{1u}},
                                                          {seqan3::detail::row_index_type{1u}, seqan3::detail::column_index_type{1u}},
                                                          {seqan3::detail::row_index_type{2u}, seqan3::detail::column_index_type{1u}}};
    std::vector<materialised_column_t> expected_range{column1, column2};
    matrix_t test_range;

    void SetUp()
    {
        test_range.reset_matrix(seqan3::detail::column_index_type{2u}, seqan3::detail::row_index_type{3u});
    }
