...
TEST_F(trace_cell_proxy_test, concepts)
{
    EXPECT_TRUE(seqan3::detail::affine_cell_proxy_instance_with_trace<cell_type>);
    EXPECT_TRUE(seqan3::detail::affine_cell_proxy_instance<cell_type>);
}
