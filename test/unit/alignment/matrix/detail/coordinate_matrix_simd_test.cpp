...
{
    using materialised_column_t = std::vector<coordinate_t, seqan3::aligned_allocator<coordinate_t, alignof(coordinate_t)>>;
    ...
    materialised_column_t column1 = materialised_column_t{{row_index_t{0}, column_index_t{0}},
                                                          {row_index_t{1}, column_index_t{0}},
                                                          {row_index_t{2}, column_index_t{0}}};
    materialised_column_t column2 = materialised_column_t{{row_index_t{0}, column_index_t{1}},
    ...
    void SetUp()
    {
        test_range.reset_matrix(column_index_t{2}, row_index_t{3});
    }
