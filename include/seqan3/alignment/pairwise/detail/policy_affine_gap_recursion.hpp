...
protected:
    ...
    explicit policy_affine_gap_recursion(alignment_configuration_t const & config)
    {
        ...
        seqan3::gap_scheme default_gap_scheme{gap_score{-1}, seqan3::gap_open_score{-10}};
        auto && selected_gap_scheme = config.template value_or<align_cfg::gap>(default_gap_scheme);
