...
struct alignment_optimum_updater_greater_equal
{
                    ...
                    rhs_t && current_cell_score_coordinate_pair) const
    {
        ...
        optimal_score = (current_cell_score >= optimal_score) ?
                        (optimal_coordinate = std::move(current_cell_coordinate), current_cell_score) :
                         optimal_score;
    }
};
...
protected:
    ...
    void reset_optimum() noexcept
    {
        ...
        optimal_coordinate.row = 0;
        optimal_coordinate.col = 0;
    }
};
} // namespace seqan3::detail
