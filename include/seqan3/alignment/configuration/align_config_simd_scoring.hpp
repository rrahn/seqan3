...
//!\cond DEV
/*!\file
 * \brief Provides seqan3::align_cfg::simd_scoring.
...
struct simd_scoring : public pipeable_config_element<simd_scoring<scoring_scheme_t>, scoring_scheme_t>
{
    //!\privatesection
    //!\brief Internal id to check for consistent configuration settings.
    static constexpr detail::align_config_id id{detail::align_config_id::simd_scoring};
};

/*!\name Type deduction guides
 * \relates seqan3::align_cfg::simd_scoring
 * \{
 */

//!\brief Deduces the scoring scheme type from the constructor argument.
template <typename scheme_t>
simd_scoring(scheme_t) -> simd_scoring<remove_cvref_t<scheme_t>>;
//!\}
