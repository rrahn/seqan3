...
// #include <seqan3/io/detail/record.hpp>                           -> replaced by #include <seqan3/nio/fastq/raw_record.hpp>
// #include <seqan3/io/sequence_file/input_format_concept.hpp>      -> replaced by #include <seqan3/nio/fastq/format.hpp>
...
public:
    ...
    //               "of fastq_file_input::field_ids for the accepted values.");
    ...
    //                                      selected_field_ids>;
    // //!\}
    using record_type = fastq_record_raw;
    ...
    fastq_file_input() = delete;
    //!\brief Copy construction is explicitly deleted, because you can't have multiple access to the same file.
    fastq_file_input(fastq_file_input const &) = delete;
    //!\brief Copy assignment is explicitly deleted, because you can't have multiple access to the same file.
    fastq_file_input & operator=(fastq_file_input const &) = delete;
    //!\brief Move construction is defaulted.
    fastq_file_input(fastq_file_input &&) = default;
    //!\brief Move assignment is defaulted.
    fastq_file_input & operator=(fastq_file_input &&) = default;
     ...
     */
    fastq_file_input(std::filesystem::path filename) :
        ...
        primary_stream{new std::ifstream{}, stream_deleter_default}
    {
        ...
        if (!primary_stream->good())
            throw std::invalid_argument{"Could not open file " + filename.string() + " for reading."};
...
protected:
    ...
    void read_next_record()
    {
        ...
        record_buffer = format.read_record(*secondary_stream);
...
template <typename t>
class fastq_file_input<t>::iterator
{
...
public:
    ...
    constexpr iterator(fastq_file_input * _host) noexcept :
        host{_host}
    {}
    //!\}
